...
export class PlaceController {
    ...
    async registerPlace(req: Request, res: Response): Promise<Response> {
    ...
    async findAllPlaces(req: Request, res: Response): Promise<Response> {
    ...
    async findPlaceById(req: Request, res: Response): Promise<Response> {
    ...
    async updatePlace(req: Request, res: Response): Promise<Response> {
    ...
    async deletePlace(req: Request, res: Response): Promise<Response> {
